package com.sanalysis.project.webapp.config;

import com.sanalysis.project.webapp.controller.HelloWorldController;
 ...
 */
@Configuration
@ComponentScan({"com.sanalysis.project.webapp",})
